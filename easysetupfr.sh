...
gh repo clone kustys/my-bash-files /tmp/my-bash-files

# Remove old bash configuration files
rm -f ~/.bashrc ~/.bash_aliases

# Copy bash files to home directory
cp /tmp/my-bash-files/.bashrc ~/
cp /tmp/my-bash-files/.bash_aliases ~/
...
cp /tmp/my-bash-files/starship.toml ~/.config/

# Remove temporary directory
sudo rm -rf /tmp/my-bash-files

echo "Bash files have been set up in your home directory."
echo "Starship configuration has been placed in ~/.config/starship.toml"
